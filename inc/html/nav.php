<nav id="navigation">
    ...
    <div id="sitenavigation" class="navigation">
        <ul>
            ...
            <li class="share">
                <a tabindex="0">
                    <svg viewBox="0 0 724.18 806.76"><g fill="#fff" color="#000"><path d="M593.95 546.3c71.92 0 130.23 58.3 130.23 130.23 0 71.92-58.3 130.23-130.23 130.23-71.92 0-130.22-58.3-130.22-130.23 0-71.92 58.3-130.22 130.22-130.22zm0-546.3c71.92 0 130.23 58.3 130.23 130.22 0 71.93-58.3 130.23-130.23 130.23-71.92 0-130.22-58.3-130.22-130.23C463.73 58.3 522.03 0 593.95 0zM130.22 273.15c71.93 0 130.23 58.3 130.23 130.23 0 71.92-58.3 130.22-130.23 130.22C58.3 533.6 0 475.3 0 403.38s58.3-130.23 130.22-130.23z" overflow="visible"/><path d="M512.86 665.27L99.1 426.4l25.88-44.84 413.76 238.9z" overflow="visible"/><path d="M516.55 146.05L102.8 384.95l25.87 44.8L542.43 190.9z" overflow="visible"/></g></svg>
                    Share</a>
                <div class="noti">
                    <span></span>
                    <div class="notitxt">
                        <input readonly="readonly" onClick="this.setSelectionRange(0, this.value.length)" class="sharelink" value="https://gallery.hackedit.de/?a=<?php echo $albumid; ?>"></input>
                    </div>
                </div>
